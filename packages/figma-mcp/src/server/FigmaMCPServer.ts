...
export class FigmaMCPServer {
  ...
  private async handleGetFigmaFile(args: any) {
    const { fileKey } = args;
  ...
  private async handleGetFigmaProject(args: any) {
  ...
  private async handleGetTeamProjects(args: any) {
    const { teamId } = args;
  ...
  private async handleValidateFigmaFile(args: any) {
    const { fileKey } = args;
  ...
  private async handleGetFileImages(args: any) {
  ...
  private async handleSyncDesignSystem(args: any) {
    ...
    // Create sync result
    const syncResult: FigmaSyncResult = {
      success: true,
